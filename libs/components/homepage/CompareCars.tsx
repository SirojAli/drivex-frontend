  ...
  return (
    <Stack className="compare-box">
      ...
      <Box className="all-img">
        <img
          src={`${REACT_APP_API_URL}/${car1?.carImages[0]}`}
          alt={'Car'}
          loading="lazy"
          className="img-1"
        />
        <img
          src={`${REACT_APP_API_URL}/${car2?.carImages[0]}`}
          alt={'Car'}
          loading="lazy"
          className="img-2"
        />
      ...
      <Stack className="main-box">
        ...
        <Box
          ...
          onClick={() => onOpenCompare([car1, car2])}
          sx={{ cursor: 'pointer' }}
        >
          <p>
      ...
      <Modal open={openCompare} onClose={handleCloseCompare}>
        ...
        >
          {selectedCars.length === 2 && (
            <CompareCarCard car1={selectedCars[0]} car2={selectedCars[1]} />
          )}
        </Box>
      </Modal>
    </Stack>
