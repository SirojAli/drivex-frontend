...
import { Stack, Typography, Box, List, ListItem, Avatar } from '@mui/material';
								...
								>
									<div className={'flex-box'}>
										{category === 'myFavorites' ? (
											<FavoriteBorderIcon className={'com-icon'} />
										) : (
											<FavoriteBorderIcon className={'com-icon'} />
										)}
								...
								>
									<div className={'flex-box'}>
										{category === 'recentlyVisited' ? (
											<AccessTimeIcon className={'com-icon'} />
										) : (
											<AccessTimeIcon className={'com-icon'} />
										)}
							...
							<List className={'sub-section'}>
								<ListItem className={pathname === 'myArticles' ? 'focus' : ''}>
									...
									>
										<div className={'flex-box'}>
											{category === 'myArticles' ? (
												<ArticleIcon className={'com-icon'} />
											) : (
												<ArticleIcon className={'com-icon'} />
											)}
									...
									>
										<div className={'flex-box'}>
											{category === 'writeArticle' ? (
												<EditNoteIcon className={'com-icon'} />
											) : (
												<EditNoteIcon className={'com-icon'} />
											)}
											<Typography className={'sub-title'} variant={'subtitle1'} component={'p'}>
					...
					<Stack className={'section'} sx={{ marginTop: '30px' }}>
						...
						<List className={'sub-section'}>
							...
							<ListItem onClick={logoutHandler}>
								<div className={'flex-box'}>
									<ExitToAppIcon className={'com-icon'} />
									<Typography className={'sub-title'} variant={'subtitle1'} component={'p'}>
										Logout
									</Typography>
								</div>
