...
import { Article, Car, ChatCircleText, Gauge, Heart, Pen, Star, User, UserSquare } from 'phosphor-react';
...
const SellerMenuList = (props: any) => {
	...
	const menu_set = [
		{
			title: 'Dashboard',
			icon: <Gauge size={20} color="#bdbdbd" weight="fill" />,
			url: '/_seller/dashboard',
		},
		{
			title: 'My Listing',
			icon: <Car size={20} color="#bdbdbd" weight="fill" />,
			url: '/_seller/myListing',
		},
		{
			title: 'Add Listing',
			icon: <UserSquare size={20} color="#bdbdbd" weight="fill" />,
			url: '/_seller/addListing',
		},
		{
			title: 'My Favorites',
			icon: <Heart size={20} color="#bdbdbd" weight="fill" />,
			url: '/_seller/myFavorites',
		},
		{
			title: 'My Blogs',
			icon: <Article size={20} color="#bdbdbd" weight="fill" />,
			url: '/_seller/myBlogs',
		},
		{
			title: 'Add Blog',
			icon: <Pen size={20} color="#bdbdbd" weight="fill" />,
			url: '/_seller/addBlog',
		},
		{
			title: 'Messages',
			icon: <ChatCircleText size={20} color="#bdbdbd" weight="fill" />,
			url: '/_seller/messages',
		},
		{
			title: 'Reviews',
