						...
						<div className={'car-price-btn'}>
							...
							{!recentlyVisited && (
								<div className={'view-like-btn'}>
									...
									<div className={'like-btn'} title={'Likes'} style={{ cursor: 'pointer' }}>
										<FavoriteIcon
											className={'like'}
		...
		return (
			<>
								...
								{!recentlyVisited && (
									<div className={'view-like-btn'}>
										<div
											...
											style={{ cursor: 'pointer' }}
										>
											<FavoriteIcon className={'like'} color="inherit" />
											<span>{car.carLikes}</span>
										</div>
										<div className={'view-btn'} title={'Views'}>
											<RemoveRedEyeIcon className={'view'} />
				...
				>
					...
					>
						{getNearestPriceCar(car, allCars) && <CompareCarPage car1={car} car2={getNearestPriceCar(car, allCars)!} />}
					</Box>
				</Modal>
			</>
		);
