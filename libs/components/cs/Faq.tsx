  ...
  const data: any = {
    cars: [
      {
        ...
        content:
          'Yes, all cars listed are thoroughly inspected and verified for quality and reliability.',
      },
      {
      ...
      },
      {
        ...
        content:
          'Typically, it takes between 3 to 7 days from choosing your car to completing paperwork and payment.',
      },
      {
        id: '00f5a45ed8897f8090116a29',
        subject: 'What if I face issues with the car after purchase?',
        content:
          'We offer post-purchase support and warranty services to help resolve any problems promptly.',
      },
      {
    ...
    payment: [
      {
        ...
        content:
          'Payments can be made through authorized dealers or via our secure online payment portal.',
      },
      {
        id: '00f5a45ed8897f8090116a91',
        subject: 'Are there any additional fees for using your services?',
        content:
          'Our services are free for buyers. Sellers pay a commission only upon successful sale.',
      },
      {
        id: '00f5a45ed8897f8090116a92',
        subject: 'Is there an option for installment payments?',
        content:
          'Yes, installment plans are available for selected cars. Please contact us for detailed options.',
      },
      {
        id: '00f5a45ed8897f8090116a93',
        subject: 'Is my payment information secure on your website?',
        content:
          'Absolutely. We use industry-standard encryption and security protocols to protect your payment data.',
      },
      {
      ...
      },
      {
        ...
        content:
          'If you encounter any payment issues, please contact our customer support immediately for assistance.',
      },
      {
      ...
      },
      {
        ...
        content:
          'Processing time depends on the payment method; credit/debit card payments are usually instant.',
      },
      {
    ...
    buyers: [
      ...
      },
      {
        ...
        content:
          'Watch for signs of accidents, rust, engine issues, unusual noises, and unclear vehicle history.',
      },
      {
    ...
    membership: [
      ...
      },
      {
        ...
        content:
          'Since membership services are not yet available, there are no fees associated at this time.',
      },
      {
      ...
      },
      {
        ...
        content:
          'Membership discounts are not currently offered, but this may change in the future.',
      },
      {
    ...
    community: [
      ...
      },
      {
        ...
        content:
          'Simply create an account and join the discussions to share your thoughts and connect with others.',
      },
      {
      ...
      },
      {
        ...
        content:
          'Currently, our platform does not support direct connections outside the community forums.',
      },
      {
      ...
      },
      {
        ...
        content:
          'Avoid sharing sensitive personal information to keep your privacy intact while participating.',
      },
      {
      ...
      },
      {
        ...
        content:
          'You can either provide correct information yourself or report the post to the admin for review.',
      },
      {
