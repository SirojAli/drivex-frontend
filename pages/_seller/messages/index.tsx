          ...
          <Stack className={'message-body'}>
            <div className={'message-bubble right'}>
              <p>
                ...
                Monthly payment:
                <br />
                If you have more questions, don’t hesitate to contact me via this number:
                09012345678.
                <br />
                I’m happy to assist!
              </p>
            ...
            <div className={'message-bubble right'}>
              <p>
                Dear Mr Williamson,
                <br />
                Thank you for inquiring Toyota Fortuner. My name is Adam, Sales Consultant at Toyota
                Cubao. If you are still interested in Toyota Fortuner, kindly answer “Yes” for the
                quotation. For any further assistance, please do not hesitate to contact me via
                09012345678 or dvg.ap.ngpmt1@gmail.com.
                <br />
