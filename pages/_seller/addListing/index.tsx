...
const AddListing: NextPage = ({ initialValues, ...props }: any) => {
  ...
  const [carTransmission, setCarTransmission] = useState<CarTransmission[]>(
    Object.values(CarTransmission),
  );
            ...
            <Stack className={'upload-box'}>
              ...
              <Stack className={'text-box'}>
                <Typography className={'drag-title'}>
                  Photos must be JPG, JPEG or PNG format
                </Typography>
                ...
                <input
                  ...
                  value={
                    insertCarData.carPrice
                      ? insertCarData.carPrice.toLocaleString('ko-KR') + ' KRW'
                      : ''
                  }
                  onChange={({ target: { value } }) => {
            ...
            <Box className={'config'}>
              ...
              <Stack className={'input-config'}>
                ...
                <input
                  ...
                  onChange={({ target: { value } }) =>
                    setInsertCarData({ ...insertCarData, carColor: value as CarColor })
                  }
                />
              </Stack>
        ...
        <Stack className={'car-desc'}>
          ...
          <Stack className={'config-column'}>
            <textarea
              ...
              onChange={({ target: { value } }) =>
                setInsertCarData({ ...insertCarData, carDescription: value })
              }
            ></textarea>
          </Stack>
        </Stack>
