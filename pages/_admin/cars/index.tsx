...
import { CarBrand, CarStatus } from '../../../libs/enums/car.enum';
    ...
    try {
      ...
      if (newValue !== 'ALL') {
        setCarsInquiry({
          ...
          search: {
            ...carsInquiry.search,
            carBrandList: [newValue as CarBrand],
          },
        });
      } else {
        delete carsInquiry?.search?.carBrandList;
        setCarsInquiry({ ...carsInquiry });
      }
    } catch (err: any) {
            ...
            <Box component={'div'}>
              ...
              <Stack className={'search-area'} sx={{ m: '24px' }}>
                <Select sx={{ width: '160px', mr: '20px' }} value={searchType}>
                  ...
                  {Object.values(CarBrand).map((brand: string) => (
